...
//        inst_add_btn.setOnAction(e -> addInstructor());
    ...
    private void showInstructorDetails(Instructors instructor) {
        ...
        hiredate_input_i.setValue(LocalDate.parse(instructor.getHireDate()));
    ...
    private void loadInstructorsData() {
        ...
        ins_col_hiredate.setCellValueFactory(new PropertyValueFactory<>("hireDate"));
    ...
    private void addInstructor() {
        ...
        if (result.isPresent() && result.get() == confirm) {
            ...
            newInstructors.setHireDate(String.valueOf(hireDate));
    ...
    private void updateInstructor() {
        ...
        if (result.isPresent() && result.get() == confirm) {
            ...
            if (instructors != null) {
                ...
                instructors.setHireDate(String.valueOf(hireDate));
...
//        member_col_type.setCellValueFactory(new PropertyValueFactory<>("membership_type_id"));
    ...
    private void addEquipment() {
        ...
        if (result.isPresent() && result.get() == confirm) {
            ...
            newEquipment.setEquipmentName(equipment_name);
            newEquipment.setCategory(category);
            newEquipment.setPurchaseDate(String.valueOf(purchase_date));
    ...
    private void updateEquipment() {
        ...
        if (result.isPresent() && result.get() == confirm) {
            if (equipment != null) {
                ...
                equipment.setPurchaseDate(String.valueOf(purchase_date));
                BigDecimal bigDecimalPrice = new BigDecimal(price);
    ...
    private void showEquipment(Equipment equipment) {
        id_input_equipment.setText(String.valueOf(equipment.getEquipmentId()));
        equipment_name_input.setText(equipment.getEquipmentName());
        ...
        purchase_date_input.setValue(LocalDate.parse(equipment.getPurchaseDate()));
